                 ...
                 <div class="rts-ht__wrapper">
                     <div class="rts-ht__email">
                         <a href="mailto:info@hostie.com"><img src="assets/images/icon/email.svg" alt=""
                                 class="icon">contact@hostie.com</a>
                     </div>
                     <div class="rts-ht__promo">
                         <p><img class="icon" src="{{asset('assets/images/icon/tag--group.svg')}}" alt=""> Hosting Flash
                             ...
                             <li class="menu-item hostie-has-dropdown">
                                 ...
                                 <ul class="hostie-submenu list-unstyled menu-pages">
                                     <li class="nav-item"><a class="nav-link"
                                             ...
                                             Checker</a></li>
                                     <li class="nav-item"><a class="nav-link"
                                             href="{{ route('domains.transfer') }}">Domain
                                             Transfer</a></li>
                                     <li class="nav-item"><a class="nav-link"
                                             href="{{ route('domains.index') }}">Domain
                                             Resigtration</a></li>
                                     <li class="nav-item"><a class="nav-link"
                                             href="{{ route('domains.index') }}">Whois</a></li>
                                 </ul>
                             </li>
                             <li class="menu-item hostie-has-dropdown">
